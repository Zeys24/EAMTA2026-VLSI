...
F {}
E {}
N -220 0 -220 50 {lab=#net1}
N -220 -0 -110 0 {lab=#net1}
N -110 -30 -110 -0 {lab=#net1}
N -110 0 0 0 {lab=#net1}
N 0 0 0 50 {lab=#net1}
N 0 0 160 0 {lab=#net1}
N -110 -150 -110 -90 {lab=#net2}
...
N 190 210 360 210 {lab=vss}
N 190 50 190 210 {lab=vss}
N 100 210 190 210 {lab=vss}
N 190 -230 190 -50 {lab=vdd}
N -0 -230 190 -230 {lab=vdd}
N 310 -0 420 0 {lab=vout}
...
C {inverter-1.1.sym} 310 0 0 0 {name=x1}
